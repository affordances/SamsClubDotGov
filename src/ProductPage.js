        ...
        <div className="pricing-and-button-container">
          {!this.props.loggedIn && (
            <div className="product-page-sign-in-container">
              <Link to="/login">
                <div
                  className="product-page-hat-icon"
                  style={{
                    mask: "url(/hat.svg) no-repeat center",
                    WebkitMask: "url(/hat.svg) no-repeat center",
                  }}
                ></div>
                <div className="product-page-sign-in">
                  {"Sign in to see Sam's price"}
                </div>
              </Link>
            </div>
          )}
          {this.props.loggedIn && (
            <div className="pricing-container">
              <div className="product-page-list-price-container">
                <div>List price:</div>
                <div className="product-page-list-price">
                  ${product.listPrice}
                </div>
              </div>
              ...
              <div className="product-page-final-price-container">
                <div>You pay:</div>
                <div className="product-page-final-price">
                  ${priceCalculation}
                </div>
              </div>
            </div>
          ...
          {this.props.loggedIn && (
            <div className="book-now-button">
              <button onClick={this.props.proceedToBooking(product)}>
                Book now
              </button>
            </div>
          )}
